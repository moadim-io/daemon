...
pub struct CronJob {
    ...
    pub updated_at: u64,
    #[serde(alias = "last_triggered_at")] // back-compat: accepts the pre-rename key on read
    pub last_manual_trigger_at: Option<u64>, // manual triggers only; scheduled fires do not update it
}
```
