...
Commit regenerated images with UI PRs so GitHub's image diff shows visual changes during review. The suite also keeps one desktop dark-mode overview baseline (`chromium-desktop-dark-overview.png`) alongside the default light screenshots.
