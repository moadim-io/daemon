...
Commit regenerated images with UI PRs so GitHub's image diff shows visual changes during review. To enforce that screenshots are current in CI or before pushing, run:
