...
#[path = "load_routine_reads_schedule_from_cron_sidecar_tests.rs"]
mod load_routine_reads_schedule_from_cron_sidecar_tests;

#[allow(
    clippy::missing_docs_in_private_items,
    reason = "split-out module keeps the file under the linecheck limit"
)]
#[path = "migrate_routine_dirs_moves_legacy_uuid_dir_to_slug_tests.rs"]
mod migrate_routine_dirs_moves_legacy_uuid_dir_to_slug_tests;
