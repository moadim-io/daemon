...
/// Collector struct for the Moadim Server REST API OpenAPI 3.0 specification.
...
#[openapi(
    ...
    paths(
        ...
        crate::routes::http::list_system_cron_jobs,
        crate::routes::cron_jobs::list,
        crate::routes::cron_jobs::create,
        crate::routes::cron_jobs::get,
        crate::routes::cron_jobs::replace,
        crate::routes::cron_jobs::update,
        crate::routes::cron_jobs::delete,
        crate::routes::cron_jobs::trigger,
    ),
    components(schemas(
...
impl ApiDoc {
    /// Serialize the full OpenAPI spec to a pretty-printed JSON string.
