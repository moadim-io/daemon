...
// `svc_list_runs`, `svc_list_all_runs`, and their shared `run_summary` helper live in
// `service_run_list.rs`, split out to stay under the repo's 500-line-per-file cap.
